...
export class AuthResolver {
    ...
    async getAuth( @Context() context: GraphQLExecutionContext): Promise<UserModel> { // TODO: getUser
        return this.usersService.getUser(context["req"].user.email); // TODO: change service
    }
